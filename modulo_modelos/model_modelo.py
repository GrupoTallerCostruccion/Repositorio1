...
def agregar_modelo(id,marca,modelo,motor,peso,descripcion,rendimiento,
                   imagen,fecha_creacion,preciolista):
	"""debe agregar un modelo de auto a la base de datos"""
	con = conectar()
        c = con.cursor()
        try:
            query ="INSERT INTO modelo(id,marca_id,modelo,motor,peso,descripcion,rendimiento,imagen,fecha_creacion,precio_lista)VALUES (?,?,?,?,?,?,?,?,?)"
            resultado = c.execute(query,[
            id,marca,modelo,motor,peso,descripcion,rendimiento,imagen,
            fecha_creacion,preciolista])
...
def eliminar_modelo(id_modelo):
    ...
    return exito
def editar_modelo(
    marca,modelo,motor,peso,descripcion,rendimiento,imagen,
    fecha_creacion,preciolista,id_mod):
    ...
    try:
        ...
        resultado = c.execute(query,
                              [marca,modelo,motor,peso,descripcion,
