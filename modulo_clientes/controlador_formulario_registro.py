...
class Display(QtGui.QDialog):
    ...
    def guardar(self):
        ...
        """
        if(self.editado):
            manejo_bd_clientes.editar_cliente(unicode(self.ui.linea_nombre.text()),
            ...
            manejo_bd_clientes.agregar_cliente(unicode(self.ui.linea_rut.text()),
